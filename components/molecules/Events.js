...
const Events = ({ events }) => {
  return (
    <div>
      ...
      <div className="scrollbar-hidden hide-scroll-bar m-auto flex w-full  overflow-x-auto xl:w-2/5  ">
        {events?.map((item, i) => {
          return (
            <div key={i} className="m-2 w-96 px-5 ">
              <h2 className="m-auto h-8  w-10 rounded-full border text-center">
                {item.time.elapsed}
              </h2>
              ...
              {item.detail == "Yellow Card" ? (
                <div className="text-center ">
                  <img
                    ...
                    alt=""
                  />
                  <span className="block text-center text-[11px]  font-bold ">
                    {item.type}
                  </span>
                  <span className="block text-center text-[11px] font-bold  ">
                    {item.player.name}
              ...
              {item.detail == "Red Card" ? (
                <div>
                  <img
                    ...
                    alt=""
                  />
                  <span className="m-auto block text-center  text-[11px]  font-bold ">
                    {item.type}
                  </span>
                  <span className="m-auto block text-center text-[11px]  font-bold">
                    {item.player.name}
